...
- [x] 1. Set up Auth.js dependencies and environment validation
  - [x] 1.1 Install next-auth@5 and create environment validation module
...
- [x] 2. Implement Auth.js configuration and route handler
  - [x] 2.1 Create Auth.js configuration with credentials provider
  ...
  - [x]* 2.2 Write property test for credential validation
...
- [x] 3. Implement middleware for route protection
  ...
  - [x]* 3.2 Write property tests for middleware route protection
...
- [x] 4. Checkpoint - Ensure auth core compiles
...
- [x] 6. Implement sign-out and update layout
  - [x] 6.1 Create sign-out button component
  ...
  - [x] 6.2 Update root layout to conditionally show header and sign-out button
...
- [x] 7. Final checkpoint - Ensure full build passes
  - Ensure all tests pass, ask the user if questions arise.
